...
%%
H = 11.21/100; % Water depth in m
W = 14.75/100; % Channel width in m
T = 15.3;  % Temperature in degree Celsius
S = 0.001435297; % Slope
log_index = Y > 0.013  & Y < 0.05;  % 0.0146 < y < 0.0517
% Linear regression to find the slope of the RSS profile
RSS_index = Y > 0.017 & Y < 0.06;
